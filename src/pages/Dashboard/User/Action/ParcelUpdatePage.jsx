        ...
        <div>
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                ...
                <div className="form-control">
                    ...
                    <input type="text" defaultValue={phone} {...register("phone", { required: true, })} placeholder="phone" className="input input-bordered" />
                ...
                <div className="form-control">
                    ...
                    <input type="text" {...register("parcel_type", { required: true, })} defaultValue={parcel_type} placeholder="parcel type" className="input input-bordered" />
                ...
                <div className="form-control">
                    ...
                    <input type="text" defaultValue={parcel_weight} onKeyUp={handlePrice} {...register("parcel_weight", { required: true, })} placeholder="parcel weight" className="input input-bordered" />
                ...
                <div className="form-control">
                    ...
                    <input type="text" defaultValue={reciever_name} {...register("reciever_name", { required: true, })} placeholder="reciever name" className="input input-bordered" />
                ...
                <div className="form-control">
                    ...
                    <input type="text" defaultValue={reciever_phone_no} {...register("reciever_phone_no", { required: true, })} placeholder="reciever phone number" className="input input-bordered" />
                ...
                <div className="form-control">
                    ...
                    <input type="text" defaultValue={delivery_address} {...register("delivery_address", { required: true, })} placeholder="parcel delivery address" className="input input-bordered" />
                ...
                <div className="form-control">
                    ...
                    <input type="date" defaultValue={delivery_date} {...register("delivery_date", { required: true, })} placeholder="Requested Delivery Date" className="input input-bordered" />
                ...
                <div className="form-control">
                    ...
                    <input type="text" defaultValue={delivery_latitude} {...register("delivery_latitude", { required: true, })} placeholder="Delivery Address Latitude" className="input input-bordered" />
                ...
                <div className="form-control">
                    ...
                    <input type="text" defaultValue={delivery_longitude} {...register("delivery_longitude", { required: true, })} placeholder="Delivery Address Longitude" className="input input-bordered" />
                ...
                <div className="form-control">
                    ...
                    <input type="text" readOnly={readOnly} defaultValue={weightPrice ? weightPrice : price} {...register("price", { required: true, })} placeholder="price" className="input input-bordered" />
                ...
                <div className="form-control mt-6">
                    {
                        ...
                        <button type="submit" className="btn btn-primary">Update Parcel</button>
                         ...
                         <p> <button type="submit" disabled={disabled} className="btn btn-primary">Update Parcel</button></p>
                         <p className="text-warning"><span className="font-semibold">Node:</span>the
                         user can update the booking only if the booking status is ‘pending’</p>
                         </div>
                    }
